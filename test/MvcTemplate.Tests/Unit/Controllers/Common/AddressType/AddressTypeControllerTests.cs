...
namespace MvcTemplate.Controllers.Common.Tests
{
    public class AddressTypeControllerTests : ControllerTests
    {
        ...
        public AddressTypeControllerTests()
        {
            ...
            type = ObjectsFactory.CreateAddressTypeView();

            controller = Substitute.ForPartsOf<AddressTypeController>(validator, service);
        ...
        {
            await service.Get<AddressTypeView>(type.Id).Returns(type);
